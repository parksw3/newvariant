...
We now cite Breda et al., and acknowledge that ``This framework ... generalizes compartmental model, such as the SEIR model''
...
\jd{Anything about the generality? I don't feel we rely much on mass-action or constant distributions.}
...
We have tried to make these distinctions clearer throughout text, including in the introduction (see response to reviewer 2). 

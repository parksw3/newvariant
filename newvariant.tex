...
Instead, biological mechanisms that cause new variant to have higher strength better translate to assuming a constant value of relative strength.
For example, if the new variant has higher transmission rate, 

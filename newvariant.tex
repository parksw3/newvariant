...
estimates of $\kappa$ range 

The squared coefficient of variation $\kappa$ of the generation-interval distribution is assumed to equal 0.2 \citep{ferretti2020quantifying};
however, we
...
\begin{equation}
\theta = \left(1 + \frac{\kappa \delta \bar{G}}{1 + \kappa r_w \bar{G}}\right)^{1/\kappa}.
\end{equation}

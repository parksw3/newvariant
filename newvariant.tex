...
(A--B) Pre-intervention (black) and post-intervention (colored) kernel of the new variant under constant-strength (A) and -speed (B) interventions assuming that the variant has equal mean generation interval as the wild type.
...
(E) Pre-intervention $\Rv$ (black) and post-intervention epidemic strength $\Ry{post}$ conditional on the mean generation interval of the variant (colored).
(F) Pre-intervention $\rv$ (black) and post-intervention epidemic speed $\ry{post}$ conditional on the mean generation interval of the variant (colored).

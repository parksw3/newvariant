...
Likewise, the post-intervention speed of the variant under the constant-speed intevention is also independent of the mean generation interval;
therefore, the constant-speed intevention will be always equally effective (on the speed scale) in preventing the spread.

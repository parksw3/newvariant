...
We explore how differences in the generation-interval distributions affect the inference of relative strength $\rho$ and speed $\delta$ in light of recent evidence that the B.1.1.7 variant may have a longer infectious period (and therefore, a longer generation interval) than prior dominant lineages.
...
Conversely, when epidemic speed is fixed, assuming longer generation intervals lead to a stronger epidemic (higher $\RR$), making the epidemic look harder to control with strength-like interventions (but not necessarily with speed-like interventions).

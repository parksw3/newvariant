...
\label{fig:Rtbias}
\end{figure}
\swp{This figure also needs to be fixed}
...
\end{figure}
\swp{JSW: I guess we can't say these are apples-to-apples comparisons... because it seems that constant speed is always better; always control, whereas constant strength does not... I see that when ratio of means <1 then better to do strength but still notable that speed ALWAYS works here.}
\swp{He also said something about constant speed not being constant effort}

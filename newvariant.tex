...
As a baseline scenario, we assume $\ry{wt}=0\,\textrm{/days}$ and $\delta=0.1\,\textrm{/days}$ (and therfore $\ry{var}=0\,\textrm{/days}$).
...
We compare how potential differences in generation-inteval distributions affect the control of the spread of the new variant using this strength-and-speed framework.

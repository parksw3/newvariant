...
Using the Gamma framework \citep{doi:10.1098/rsif.2020.0144} can help us evaluate these differences more clearly.
...
Instead, if we consider short and wide generation interval estimates from Tianjin, China ($\Gw=\Gv=2.57\days$ and $\kappa=1$; \cite{ganyani2020estimating}), we obtain $\rho=1.27$ (from $\delta=0.104\pday$ and $\rw = 0\pday$; \cite{davies2021estimated}).

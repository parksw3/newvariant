...
\caption{
\textbf{Relative speed of the new variant assuming a fixed strength advantage $\rho$ u under five epidemiological conditions.}
...
In order to allow for changes in $\RR$ driven by the introduction and lifting of non-pharmaceutical interventions, we let $\Rw(t)$ to decrease from 2 to 0.4 around day 30 and increase back up to 1 around day 60 and assume $\Rv(t) = \rho \Rw(t)$.
...
In Supplementary Figure S1, we show that using a step function does not affect our conclusions.

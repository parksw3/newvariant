...
In this case, the latter study's longer mean generation interval (which increases $\rho$) is counter-balanced by the effects of their wider distribution (which decreases $\rho$); calculations using our approximation framework produce qualitatively similar results.

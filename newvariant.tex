...
For example, when we assume a fixed value of epidemic strength, longer generation intervals lead to a slower epidemic (lower $r$), making the epidemic easier to control.
When we assume a fixed value of epidemic speed, longer generation intervals lead to a stronger epidemic (higher $\RR$), making the epidemic more difficult to control.
...
We reach similar conclusiosn if we use a step function instead (Supplementary Figure S1).

...
\jd{If you add $\rw$ to the figure titles, you could skip this sentence and make life easier for readers.} Five epidemiological conditions assume $\rw=-0.15\pday$ ($\rw < \rv < 0$), $\rw=-0.1\pday$ ($\rw < \rv = 0$), $\rw=-0.05\pday$ ($\rw < 0 < \rv$), $\rw=0\pday$ ($0 = \rw < \rv$), and $\rw=0.05\pday$ ($0 < \rw < \rv$).
}

...
We do not generally expect the relative speed $\delta$ to remain fixed if other factors governing epidemic spread are changing on the time scale of the invasion of a new variant relative to that of a wild type.

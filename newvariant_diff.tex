...
\end{equation}
\DIFaddbegin \DIFadd{We note that $\kappa_x^{-1}$ also corresponds to the shape parameter of a Gamma distribution.
}\DIFaddend Various Gamma-generation-interval assumptions have been widely used in epidemic modeling, including for models of SARS-CoV-2 \citep{doi:10.1098/rsif.2020.0144}.
...
\DIFaddbegin \DIFadd{We thus ask: what factors affect the relative strength $\rho = \Rv/\Rw$ of a new variant, conditional on an observed relative speed $\delta$?
}\DIFaddend Inference of the relative strength $\rho = \Rv/\Rw$ from the relative speed $\delta$ depends on assumptions about the generation-interval distributions of both strains.
...
While the forward distribution is more reliable, changes in epidemic dynamics due to intervention measures and susceptible depletions can affect the shape of the distribution \mbox{%DIFAUXCMD
